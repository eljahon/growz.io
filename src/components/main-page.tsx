  ...
  return (
    <div>
      <section>
        ...
        <div className="relative max-w-[1500px]" data-aos="fade-up">
          ...
          <span className="absolute bottom-[-235px] lg:bottom-[-230px] sm:right-[-10px] lg:right-[-40px]">
      ...
      <section
        className="mt-[320px] flex items-center justify-center lg:mt-[400px] lg:h-[610px] pt-2 container"
        id="about"
      >
        <div className="w-[80%]">
          ...
          <div className="lg:flex items-center lg:mt-[160px] gap-x-[100px] mt-[27px] pb-9">
